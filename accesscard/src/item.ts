...
export default class Button implements IScript<Props> {
  ...
  clip = new AudioClip('accesscard/sounds/use.mp3')
  canvas = new UICanvas()
  container = new UIContainerStack(this.canvas)
  texture = new Texture('accesscard/images/Key.png')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    key.addComponent(new GLTFShape('accesscard/models/Blue_Access_Card.glb'))
    key.addComponent(
      new OnPointerDown(
        () => {
